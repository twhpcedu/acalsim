...
public:
	SST_ELI_REGISTER_COMPONENT(HSAHostComponent, "acalsim", "HSAHost", SST_ELI_ELEMENT_VERSION(1, 0, 0),
	                           "HSA Host Agent Component for job submission", COMPONENT_CATEGORY_PROCESSOR)
	...
	SST_ELI_DOCUMENT_PORTS({"aql_port", "AQL packet submission port", {"ACALSim.HSA.HSAAQLPacketEvent"}},
	...
	SST_ELI_DOCUMENT_STATISTICS({"dispatches_submitted", "Total kernel dispatches submitted", "dispatches", 1},
