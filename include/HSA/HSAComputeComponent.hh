...
public:
    SST_ELI_REGISTER_COMPONENT(
        ...
        "HSA Compute Agent Component for kernel execution",
    ...
    SST_ELI_DOCUMENT_PORTS(
        {"aql_port", "AQL packet reception port", {"ACALSim.HSA.HSAAQLPacketEvent"}},
    ...
    SST_ELI_DOCUMENT_STATISTICS(
        {"kernels_executed", "Total kernels executed", "kernels", 1},
