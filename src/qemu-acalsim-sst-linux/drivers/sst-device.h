/*
 * VirtIO SST Device Driver - Header
 *
...
/* Sysfs Attributes */
ssize_t sst_sysfs_show_stats(struct device *dev, struct device_attribute *attr,
                             char *buf);
ssize_t sst_sysfs_show_config(struct device *dev, struct device_attribute *attr,
                              char *buf);
