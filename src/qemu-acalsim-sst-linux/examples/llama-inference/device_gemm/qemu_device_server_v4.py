...
#!/usr/bin/env python3
"""QEMU Device Server v4 - Uses shared folder for bridge socket"""
...
class SSTKernelLauncher:
	...
	def __init__(self):
		# Use shared folder socket (accessible from both Docker and QEMU)
	...
	def connect_to_bridge(self):
		if not os.path.exists(self.bridge_socket):
			...
			print("Make sure SST bridge is running in Docker")
			self.sst = None
			return
		try:
...
if __name__ == "__main__":
	print("=" * 60)
	print("QEMU Device Server v4 - Shared Folder Bridge")
	print("=" * 60)
	print()
