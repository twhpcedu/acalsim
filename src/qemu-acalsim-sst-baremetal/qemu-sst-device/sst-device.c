 ...
 */
static bool sst_send_request(SSTDeviceState *s, struct MMIORequest *req,
...
static uint64_t sst_device_read(void *opaque, hwaddr addr, unsigned size)
{
    ...
    default:
        qemu_log("SST Device: Read from unknown offset 0x%lx\n", addr);
        break;
    }
                             ...
                             uint64_t val, unsigned size)
{
    ...
    default:
        qemu_log("SST Device: Write to unknown offset 0x%lx\n", addr);
        break;
    }
}
